...
CREATE TABLE `cms_comments_data_1` (
  ...
  KEY `id` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='评论副表1';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='表情数据表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='评论自定义字段表';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='评论配置';
